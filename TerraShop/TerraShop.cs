...
namespace TerraShop
{
    ...
    public class TerraShop : TerrariaPlugin
    {
        ...
        {
            // 1. Buscamos todos los ítems en la tienda donde el jugador es el vendedor
            var myItems = ShopCore.GlobalShop.Where(i => i.Seller == args.Player.Account.Name).ToList();

            // 2. Iteramos sobre los ítems para devolverlos y borrarlos de la tienda
            ...
            // 3. Guardamos el personaje y actualizamos el archivo .json
