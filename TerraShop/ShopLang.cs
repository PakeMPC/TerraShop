    ...
    public static class ShopLang
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Languages = new Dictionary<string, Dictionary<string, string>>
        {
            ["es"] = new Dictionary<string, string> {
                ...
                { "PENDING_OFFER_EXISTS", "Este jugador ya tiene una oferta pendiente. Espera a que la responda o expire." },
            },
            ["en"] = new Dictionary<string, string> {
                ...
                { "PENDING_OFFER_EXISTS", "This player already has a pending offer. Wait for them to respond or for it to expire." },
            ...
            ["pt"] = new Dictionary<string, string> {
                ...
                { "PENDING_OFFER_EXISTS", "Este jogador já tem uma oferta pendente. Aguarde ele responder ou a oferta expirar." },
            }
        };
